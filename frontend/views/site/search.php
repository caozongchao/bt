                ...
                <ul class="media-list">
                    ...
                    <li class="media">
                        ...
                        <div class="media-body" style="padding-bottom:5px; border-bottom:1px solid #dddddd;">
                            <div class="media-heading" style="font-size:16px;"><a href="<?=Url::to(['site/detail','id' => $value->id])?>"><?=ColorHelper::red($value->name,$k)?> </a><small><i class="fa fa-file"></i> <span class="badge" style="background-color: #FFCC99"><?=$value->num?></span></small></div>
